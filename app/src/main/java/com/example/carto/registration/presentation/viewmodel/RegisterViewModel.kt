...
import com.example.carto.registration.presentation.utils.toUserMessage
import com.example.carto.registration.presentation.utils.toValidatedInput
        ...
        viewModelScope.launch {
            ...
            when (
                val result = runCatching {
                    ...
                    RegisterResult.Failure(
                        RegisterFailure(
                            ...
                            message = "Unexpected ViewModel registration failure: ${exception::class.java.name}. ${exception.message.orEmpty().ifBlank { "No message provided." }}",
                        )
                    )
                }
            ) {
                ...
                is RegisterResult.Failure -> {
                    Log.e(TAG, "Register failed. type=${result.failure.type}, details=${result.failure.message}")
