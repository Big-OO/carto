...
import com.shopify.carto.feature.profile.data.remote.network.RetrofitProfileNetworkDataSource
...
object ProfileDIModule {
    ...
    @Provides
    @Singleton
    fun provideProfileShopifyApi(@AdminRetrofit retrofit: Retrofit): ProfileShopifyApi {
        return retrofit.create(ProfileShopifyApi::class.java)
    }

    @Provides
    @Singleton
    fun provideProfileService(@AdminRetrofit retrofit: Retrofit): ProfileService {
    ...
    fun provideProfileNetworkDataSource(
        dataSource: RetrofitProfileNetworkDataSource,
    ...
    fun provideProfileRemoteDataSource(
        ...
        return ProfileRemoteDataSourceImpl(networkDataSource, config)
    }
